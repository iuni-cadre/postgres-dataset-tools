...
-- MAG parser in the MicrosoftAcademicGraphParser git repo.
...
\COPY oamag_core.paper_urls FROM '/N/project/mag/FilteredMagData/openalex_mag_2022/oa_paperURLs.csv' DELIMITER '~' ENCODING 'UTF-8' CSV HEADER;
